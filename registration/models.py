...
class Client(models.Model):
    ...
    id_shop = models.OneToOneField(User, on_delete = models.CASCADE, primary_key = True)
    id_user = models.OneToOneField(Shop, on_delete = models.CASCADE, primary_key = True) 
